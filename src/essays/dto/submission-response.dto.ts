...
export class SubmissionResponseDto {
  ...
  @ApiProperty({
    description: '제출물 본문 내용',
    example: 'This is my submission about English language learning...',
  })
  submitText: string;

  @ApiProperty({
    description: '제출물 구성 요소 유형',
    enum: ComponentType,
  ...
  @ApiProperty({
    ...
    example: 'This is my submission with <b>excellent vocabulary</b>...',
    required: false,
  })
  ...
  @ApiProperty({
    ...
    example: 'https://storage.example.com/videos/submission1_video.mp4',
    required: false,
  })
  videoUrl?: string;
...
export class SubmitSubmissionResponseDto {
  @ApiProperty({
    description: '제출된 제출물 ID',
    example: 1,
  })
  submissionId: number;
  ...
  @ApiProperty({
    description: '응답 메시지',
    example: '제출물이 성공적으로 제출되었습니다. 평가가 진행 중입니다.',
    required: false,
    nullable: true,
  })
  message: string | null;
